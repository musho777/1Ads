...
const translations = {
  en: {
    ...
    'campaign.ad.image.label': 'Image URL',
    'campaign.ad.image.description': 'Enter a valid image URL (2:1 aspect ratio required)',
    ...
    'campaign.ad.video.label': 'Video URL',
    'campaign.ad.video.description': 'Enter a valid video URL (2:1 aspect ratio required)',
    'campaign.ad.thumbnail.label': 'Video Thumbnail URL',
  ...
  ru: {
    ...
    'campaign.ad.image.label': 'URL изображения',
    'campaign.ad.image.description': 'Введите действительный URL изображения (требуется соотношение 2:1)',
    ...
    'campaign.ad.video.label': 'URL видео',
    'campaign.ad.video.description': 'Введите действительный URL видео (требуется соотношение 2:1)',
    'campaign.ad.thumbnail.label': 'URL превью видео',
